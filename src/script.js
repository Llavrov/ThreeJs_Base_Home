...
const bushMaterial = new THREE.MeshStandardMaterial({color: "#129129"})
door.geometry.setAttribute(
    'uv2',
    new THREE.Float32BufferAttribute(door.geometry.attributes.uv.array, 2)
)
...
const tick = () =>
{
    ...
    ghost3.position.x = Math.cos(ghost3Angle) * (7 + Math.sin(ghost3Angle * 3));
    ghost3.position.z = Math.sin(ghost3Angle) * (7 + Math.sin(ghost3Angle * 3));
    ghost3.position.y = Math.sin(ghost3Angle * 3) + Math.sin(ghost3Angle * 3);
